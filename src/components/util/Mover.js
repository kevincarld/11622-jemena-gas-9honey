...
export default function Mover({ x, y, move, scale, children, overrideMobile, shouldAlwaysCompleteAnimation, ...chakra }) {
  ...
  return (
    <Box {...chakra}>
      <Parallax
        ...
        {...(shouldAlwaysCompleteAnimation && (isDesktop || overrideMobile) && { shouldAlwaysCompleteAnimation })}
