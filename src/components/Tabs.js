    ...
    <Box bg='sky' color='white' pb={{base: '40px', lg: '80px', d:'114px'}}>
      ...
      <Grid sx={styles.cards} templateColumns={{md: 'repeat(2, 375px)', d: 'repeat(3, 400px)'}} gap={{base: '13px'}}>
        ...
        <Box as={motion.div} variants={cardVariants} initial='initial' whileHover='hovered'  className='card card__5'>
          ...
          <Text as={motion.p} variants={contentVariants} className='content'>Natural gas has a distinctive smell, making it easy to detect a leak.</Text>
        </Box>
        ...
        <Box as={motion.div} variants={cardVariants} initial='initial' whileHover='hovered'  className='card card__6'>
          ...
          <Text as={motion.p} variants={contentVariants} className='content'>For every natural gas appliance you buy, you could receive up to $500 cash back, straight in your back pocket, via redemption and for a limited time.</Text>
        </Box>
...
const styles = {
  cards: {
    ...
    '.card': {
      bg: 'white',
      p: {base: '40px 30px 80px', base: '40px 30px 70px'},
      w: 'full',
